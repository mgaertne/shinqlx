...
def send_server_command(_client_id: int | None, _cmd: str) -> bool: ...
def client_command(_client_id: int, _cmd: str) -> bool: ...
...
def set_holdable(_client_id: int, _holdable: int) -> bool: ...
