...
class Redis(AbstractDatabase):
    ...
    @overload
    def zincrby(self, name: str, value: int | float, amount: str) -> float: ...
    @overload
    def setex(self, name: str, value: str, time: int | timedelta) -> bool: ...
    @overload
    def setex(self, name: str, value: int | timedelta, time: str) -> bool: ...
    @overload
    def lrem(self, name: str, value: str, count: int) -> int: ...
    @overload
    def lrem(self, name: str, value: int, count: str) -> int: ...
