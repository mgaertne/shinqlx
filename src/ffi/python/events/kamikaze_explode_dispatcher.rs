...
impl KamikazeExplodeDispatcher {
    ...
    fn dispatch<'py>(
        ...
        slf.dispatch(player, is_used_on_demand)
    }
}

pub(crate) trait KamikazeExplodeDispatcherMethods<'py> {
    fn dispatch(
        &self,
        player: &Bound<'py, Player>,
        is_used_on_demand: bool,
...
impl<'py> KamikazeExplodeDispatcherMethods<'py> for Bound<'py, KamikazeExplodeDispatcher> {
    fn dispatch(
        &self,
        player: &Bound<'py, Player>,
        is_used_on_demand: bool,
...
#[cfg(test)]
mod kamikaze_explode_dispatcher_tests {
    use super::{KamikazeExplodeDispatcher, KamikazeExplodeDispatcherMethods};
